...
@page
@model ElectHub.Pages.Clients.EditModel
@{
}
...
@if (Model.errorMessage.Length > 0) {
    <div class='alert-warning alert-dimissible fade show' role='alert'>
...
namespace ElectHub.Pages.Clients
{
    public class EditModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            try
            {
                String connectionString = "Data Source=localhost\\SQLEXPRESS;Initial Catalog=Registery;Integrated Security=True";
